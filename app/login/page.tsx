...
export default async function LoginPage(props: { searchParams: Promise<{ message: string }> }) {
  ...
  return (
    <div className="min-h-screen mesh-bg bg-background flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background orbs */}
      <div className="absolute top-0 left-0 w-80 h-80 bg-violet-500 dark:bg-violet-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[120px] opacity-20 dark:opacity-10 animate-float" />
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-cyan-400 dark:bg-cyan-500 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[120px] opacity-20 dark:opacity-10 animate-float" style={{animationDelay: '1.5s'}} />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted dark:text-gray-400 mt-2">Log in to your study dashboard</p>
        </div>
          ...
          <form className="space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-[var(--card-bg)] text-muted dark:text-gray-500 font-medium">or sign in with email</span>
              </div>
            </div>
            ...
            <button formAction={login} className="btn-primary w-full text-center py-3.5 rounded-2xl text-base">
              Sign In →
            </button>
          </form>
